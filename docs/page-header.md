---
descript: Top area of the page that provides the context for the user. It must have a title and can have toolbar, back button, tablist, and description text. Can only be used inside AppShell > PageGrid.
---
